  ...
  function getattrs(out,attrs,asarrays) {
    attrs.forEach(function(attr){
      ...
      if( asarrays ) {
        ...
        if(typeof out[attr.Name] == 'undefined'){
            out[attr.Name] = attr.Value;
        }else if(typeof out[attr.Name] == 'string' || typeof out[attr.Name] == 'number'){
          out[attr.Name] = [out[attr.Name]];
          out[attr.Name].push(attr.Value);
        }else if(Object.prototype.toString.call(out[attr.Name]) == '[object Array]'){
          out[attr.Name].push(attr.Value);
        }
